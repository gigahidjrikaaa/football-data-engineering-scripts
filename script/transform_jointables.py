...
def join_tables():
    ...
    joined_table1_2 = pd.merge(table1, table2, left_on=['homeTeam'], right_on=['TeamName'], how='left', suffixes=('', '_away'))
    joined_table1_2 = pd.merge(joined_table1_2, table2, left_on=['awayTeam'], right_on=['TeamName'], how='left', suffixes=('_home', '_away'))
    ...
    joined_table1_2 = joined_table1_2.drop(columns=['TeamID_home', 'TeamID_away', 'TeamName_home', 'TeamName_away'])
